...
for i=1:5
    ...
    loc_fldr=['exp2_BF_NT_2_' num2str(i) '/'];
...
%     [~, ~,...
%         ~, ~,...
%         ~, pivDIVall_NT_2mg_blured_thr10,...
%         pivCURLz_NT_2mg_blured_thr10, pivCURLav_NT_2mg_blured_thr10,...
%         pivCURLz_all_NT_2mg_blured_thr10, pivCURLav_all_NT_2mg_blured_thr10] = ...
%         piv_obj_to_matrix(exp2_pivobj_NT_2_mg_blured_stripes_thr10{i});
    
    
    for t=70:89
        
        im_NT_2_mg_h=imread([the_folder the_tif_files_h(t).name]);
        %subplot(1,2,1)
        imshow(im_NT_2_mg_h)
        
        hold on
        
        quiver(exp2_pivobj_NT_2_mg_blured_stripes_thr10{i}.xs(:,t-70+1),...
            exp2_pivobj_NT_2_mg_blured_stripes_thr10{i}.ys(:,t-70+1),...
            exp2_pivobj_NT_2_mg_blured_stripes_thr10{i}.vxs(:,t-70+1),...
            exp2_pivobj_NT_2_mg_blured_stripes_thr10{i}.vys(:,t-70+1))
        ...
        saveas(fig,...
            [the_folder ...
            'exp2_field_velocity_thr10_bluredNT_2_mg_'...
